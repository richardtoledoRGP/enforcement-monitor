...
against financial institutions and stores them in a SQLite database.
View results via the Streamlit dashboard (streamlit run dashboard.py).

Usage:
    python main.py                                  # Static sources only
    python main.py --dry-run                        # Print results to console
    python main.py --with-browser                   # Include JS-rendered sources
...
def main():
    ...
    parser.add_argument("--dry-run", action="store_true", help="Print results to console without updating DB")
